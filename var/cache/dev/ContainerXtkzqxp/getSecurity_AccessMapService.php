...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/story'), array(0 => 'ROLE_POWER_USER', 1 => 'ROLE_MODERATOR', 2 => 'ROLE_ADMIN'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/scenes'), array(0 => 'ROLE_POWER_USER', 1 => 'ROLE_MODERATOR', 2 => 'ROLE_ADMIN'), NULL);
