...
namespace Proxies\__CG__\NS\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \NS\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'NS\\UserBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'NS\\UserBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'NS\\UserBundle\\Entity\\User' . "\0" . 'biographie', '' . "\0" . 'NS\\UserBundle\\Entity\\User' . "\0" . 'profile', '' . "\0" . 'NS\\UserBundle\\Entity\\User' . "\0" . 'profileFile', '' . "\0" . 'NS\\UserBundle\\Entity\\User' . "\0" . 'created_at', '' . "\0" . 'NS\\UserBundle\\Entity\\User' . "\0" . 'updatedAt', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
     ...
     * {@inheritDoc}
     */
    public function setProfileFile(\Symfony\Component\HttpFoundation\File\File $image = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProfileFile', [$image]);

        return parent::setProfileFile($image);
    }
